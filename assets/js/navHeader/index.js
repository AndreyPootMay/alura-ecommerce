...
export function nav(paths) {
  ...
  <div class="navHeader__left">
    ...
    <div class="navHeader__search">
      <input type="text" class="navHeader__search--input" placeholder="¿Qué desea encontrar?"/>
      <img src="${paths.lupa}" alt="Imagen de una lupa" class="navHeader__search--img">
    </div>
  </div>
  ${paths.login && (`<div class="navHeader__login"><a href="${paths.login}" class="btn__login">Login</a><img class="lupa__hidden" src="${paths.lupa}" alt="imagem de uma lupa" data-input/></div><input type="text" class="lupa__hidden--input" placeholder="¿Qué desea encontrar?"/>`)}
  `;
...
export function footer(paths) {
  ...
  <section class="footer">
    <div class="container">
      ...
      <div class="footer__text">
        ...
        <a href="#">Finalidad del programa</a href="">
  ...
  <p>Desarrollado por Niger Andrey Poot May</p>
  </div>
  `;
